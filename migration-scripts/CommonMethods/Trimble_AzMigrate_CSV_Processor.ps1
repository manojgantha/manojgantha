class CsvProcessor {
    ...
    [string] GetCsvOutputPath($resolvedCsvPath) {
        ...
        $dirPathforLogs = [string]::Concat($dirPath, "\Trimble_AzMigrate_Logs")
        ...
        if (-not (Test-Path -LiteralPath $dirPathforLogs)) {            
            try {
                ...
                $CsvOutputFileName = [string]::Concat("Trimble_AzMigrate_Logs\", "Trimble_AzMigrate_out.", $scriptName, ".", $csvFileName, ".", $this.FormatDate($startDate), ".csv")
            }
            catch {                
                ...
                $CsvOutputFileName = [string]::Concat("Trimble_AzMigrate_out.", $scriptName, ".", $csvFileName, ".", $this.FormatDate($startDate), ".csv")                
            }
        }
        else {
            $CsvOutputFileName = [string]::Concat("Trimble_AzMigrate_Logs\", "Trimble_AzMigrate_out.", $scriptName, ".", $this.FormatDate($startDate), ".csv")
